...
{
    public class Productss : Controller
    {
        private readonly MyDbContext _context;

        public Productss(MyDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ProductId,Name,Price,Description,Image,QuantityInStock")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductId,Name,Price,Description,Image,QuantityInStock")] Product product)
        {
